...
import com.quran.labs.androidquran.module.application.DebugNetworkModule_ProvideOkHttpClientFactory;
...
public final class DaggerDebugApplicationComponent implements DebugApplicationComponent {
  ...
  private DaggerDebugApplicationComponent(Builder builder) {
    initialize(builder);
  }
  ...
  private void initialize(final Builder builder) {
    ...
    this.provideOkHttpClientProvider =
        DoubleCheck.provider(DebugNetworkModule_ProvideOkHttpClientFactory.create());
  ...
  public static final class Builder {
    ...
    public DebugApplicationComponent build() {
      if (applicationModule == null) {
        throw new IllegalStateException(
            ApplicationModule.class.getCanonicalName() + " must be set");
      }
      return new DaggerDebugApplicationComponent(this);
    }
    ...
    public Builder debugNetworkModule(DebugNetworkModule debugNetworkModule) {
      Preconditions.checkNotNull(debugNetworkModule);
      return this;
    }
  ...
  private final class PagerActivityComponentImpl implements PagerActivityComponent {
    ...
    private InlineTranslationPresenter getInlineTranslationPresenter() {
      return InlineTranslationPresenter_Factory.newInlineTranslationPresenter(
          ...
          DaggerDebugApplicationComponent.this.translationsDBAdapterProvider.get(),
          DaggerDebugApplicationComponent.this.provideQuranSettingsProvider.get(),
          DaggerDebugApplicationComponent.this.getQuranInfo());
    }
    ...
    private void initialize(final PagerActivityComponentBuilder builder) {
      this.provideImageWidthProvider =
          DoubleCheck.provider(
              PagerActivityModule_ProvideImageWidthFactory.create(
                  ...
                  DaggerDebugApplicationComponent.this.quranScreenInfoProvider));
      this.quranPageWorkerProvider =
          DoubleCheck.provider(
              QuranPageWorker_Factory.create(
                  DaggerDebugApplicationComponent.this.provideApplicationContextProvider,
                  DaggerDebugApplicationComponent.this.provideOkHttpClientProvider,
                  provideImageWidthProvider,
                  DaggerDebugApplicationComponent.this.quranScreenInfoProvider,
                  DaggerDebugApplicationComponent.this.quranFileUtilsProvider));
      this.recentPagePresenterProvider =
          DoubleCheck.provider(
              RecentPagePresenter_Factory.create(
                  DaggerDebugApplicationComponent.this.recentPageModelProvider));
      ...
      this.quranAppUtilsProvider =
          SingleCheck.provider(
              QuranAppUtils_Factory.create(DaggerDebugApplicationComponent.this.quranInfoProvider));
      this.shareUtilProvider =
          SingleCheck.provider(
              ShareUtil_Factory.create(DaggerDebugApplicationComponent.this.quranInfoProvider));
    ...
    private PagerActivity injectPagerActivity(PagerActivity instance) {
      ...
      PagerActivity_MembersInjector.injectBookmarkModel(
          instance, DaggerDebugApplicationComponent.this.bookmarkModelProvider.get());
      ...
      PagerActivity_MembersInjector.injectQuranSettings(
          instance, DaggerDebugApplicationComponent.this.provideQuranSettingsProvider.get());
      PagerActivity_MembersInjector.injectQuranScreenInfo(
          instance, DaggerDebugApplicationComponent.this.getQuranScreenInfo());
      PagerActivity_MembersInjector.injectArabicDatabaseUtils(
          instance, DaggerDebugApplicationComponent.this.arabicDatabaseUtilsProvider.get());
      PagerActivity_MembersInjector.injectTranslationsDBAdapter(
          instance, DaggerDebugApplicationComponent.this.translationsDBAdapterProvider.get());
      ...
      PagerActivity_MembersInjector.injectAudioUtils(
          instance, DaggerDebugApplicationComponent.this.audioUtilsProvider.get());
      PagerActivity_MembersInjector.injectQuranInfo(
          instance, DaggerDebugApplicationComponent.this.getQuranInfo());
      PagerActivity_MembersInjector.injectQuranFileUtils(
          instance, DaggerDebugApplicationComponent.this.getQuranFileUtils());
      return instance;
    }
        ...
        this.quranPagePresenterProvider =
            DoubleCheck.provider(
                QuranPagePresenter_Factory.create(
                    DaggerDebugApplicationComponent.this.bookmarkModelProvider,
                    PagerActivityComponentImpl.this.coordinatesModelProvider,
                    DaggerDebugApplicationComponent.this.provideQuranSettingsProvider,
        ...
        this.ayahTrackerPresenterProvider =
            DoubleCheck.provider(
                AyahTrackerPresenter_Factory.create(
                    DaggerDebugApplicationComponent.this.quranInfoProvider,
                    DaggerDebugApplicationComponent.this.quranFileUtilsProvider));
        this.translationPresenterProvider =
            DoubleCheck.provider(
                TranslationPresenter_Factory.create(
                    ...
                    DaggerDebugApplicationComponent.this.provideQuranSettingsProvider,
                    DaggerDebugApplicationComponent.this.translationsDBAdapterProvider,
